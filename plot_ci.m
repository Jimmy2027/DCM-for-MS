function plot_ci(E,C,i,x,j,s) 
% this is a changed version of the spm-function spm_plot_ci(E,C,x,j,s)
%--------------------------------------------------------------------------
...
% i index of covariate for legend 
% x - domain
% j - rows of E to plot
...
if CR
    ...
    fill(x(16,:)',y(16,:)',[1 1 1]*gr,'EdgeColor',[1 1 1]*.2,'Parent',ax);
    hold(ax,'on');
    plot(ax,E(1),E(2),'.','MarkerSize',10);
    hold(ax,'off'); drawnow
    return
end
...
legend(legenden{i},'confidence interval')
